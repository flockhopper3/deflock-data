...
- **z0–z10** — Tippecanoe-clustered points (`--cluster-distance=10 --cluster-maxzoom=10`); each cluster carries `point_count`, which the heatmap layer uses as its density weight
